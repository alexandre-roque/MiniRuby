...
public class AccessExpr extends SetExpr{
    ...
    // Se não tiver index, retornar o valor.
    // Se tiver index, vai ser um array, retornar o .get no index passado
    ...
    // Se tiver index tem que ser um array, buscar no indice e sobrescrever ou acrescentar
    // Se não tiver index, conferir se é Integer ou String, e retornar os devidos valores
}
